...
import (
	...
	elastictl "github.com/fluid-cloudnative/fluid/pkg/controllers/v1alpha1/elastic"
)
...
var cmd = &cobra.Command{
	...
	Short: "controller for elastic",
}

var startCmd = &cobra.Command{
	Use:   "start",
	Short: "start elastic-controller in Kubernetes",
...
func handle() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "97758316.data.fluid.io",
		Port:               9443,
	})
	if err != nil {
		setupLog.Error(err, "unable to start elastic manager")
		os.Exit(1)
	}
	...
	setupLog.Info("starting elastic-controller")
	if err := mgr.Start(ctrl.SetupSignalHandler()); err != nil {
		setupLog.Error(err, "problem running elastic-controller")
		os.Exit(1)
	}
}
